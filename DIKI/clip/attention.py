...
def multi_head_attention_forward(
    ...
    if prefix is not None:
        ...
        if batch_weight is not None:
            attn_output_prefix = attn_output_prefix * batch_weight.type(attn_output_prefix.dtype).view(bsz, 1, 1, 1) # changed from default: attn_output_prefix = attn_output_prefix * batch_weight.view(bsz, 1, 1, 1) for attn gradient problem
        ...
        attn_output = attn_output + attn_output_prefix
